...
from electrum.khc.gui.kivy.uix.dialogs import EventsDialog
from electrum.khc.gui.kivy.i18n import _
from electrum.khc.base_wizard import BaseWizard
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum.khc.mnemonic import Mnemonic
        from electrum.khc.old_mnemonic import words as old_wordlist
