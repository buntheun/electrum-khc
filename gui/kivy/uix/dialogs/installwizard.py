...
from electrum_khc_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_khc.mnemonic import Mnemonic
        from electrum_khc.old_mnemonic import words as old_wordlist
