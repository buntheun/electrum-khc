...
from electrum_khc import coinchooser
from electrum_khc.util import fee_levels

from choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_khc_gui.kivy.i18n._
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for KHcoin amounts.")
                    action: partial(root.unit_dialog, self)
                CardSeparator
                SettingsItem:
                    status: root.fee_status()
                    title: _('Fees') + ': ' + self.status
                    description: _("Fees paid to the KHcoin miners.")
