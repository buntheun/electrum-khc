...
from electrum.khc.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum.khc.import bitcoin
from electrum.khc.util import timestamp_to_datetime
from electrum.khc.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        import electrum.khc.as electrum
        try:
    ...
    def do_save(self):
        ...
        from electrum.khc.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum.khc.util import create_URI
