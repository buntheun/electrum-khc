...
from electrum.khc.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum.khc.transaction import deserialize, Transaction
from electrum.khc.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
